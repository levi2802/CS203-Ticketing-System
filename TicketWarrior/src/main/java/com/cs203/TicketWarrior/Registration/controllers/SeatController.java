...
public class SeatController {
    ...
    public ResponseEntity<Seat> addSeat(@RequestBody Seat seat, @RequestBody Order newOrder) throws Exception {
        return new ResponseEntity<Seat>(seatService.insert(seat, newOrder), HttpStatus.OK);// Sends Http status code
                                                                                           // 200.
    }
}
